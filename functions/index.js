    ...
    querySnapshot.forEach(doc => {
      ...
      admin
        ...
        .then(doc => {
          ...
          return console.log("error on Update timeline post");
        }).catch((error) => {
                              console.error(error);
                            });
    });
    ...
    querySnapshot.forEach(doc => {
      ...
      admin
        ...
        .then(doc => {
          ...
          return console.log("error on delete post1");
        }).catch((error) => {
                              console.error(error);
                            });
    });
      ...
      querySnapshot.forEach(doc => {
        ...
        admin
          ...
          .then(doc => {
            ...
            return console.log("error on onUpdatePost");
          }).catch((error) => {
                                console.error(error);
                              });
      });
      ...
      querySnapshot.forEach(doc => {
        ...
        admin
          ...
          .then(doc => {
            ...
            return console.log("error on delete post");
          }).catch((error) => {
                    console.error(error);
                  });
      });
